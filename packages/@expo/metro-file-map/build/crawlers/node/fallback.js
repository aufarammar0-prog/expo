...
function createFallbackFilesystem(opts) {
    ...
    function readdir(absolutePath, dirNode) {
        ...
        for (const entry of dirEntries) {
            ...
            const childPath = absolutePath + path_1.default.sep + name;
            if (ignore(childPath)) {
                continue;
            }
            if (entry.isDirectory()) {
                ...
                try {
                    const target = fs_1.default.readlinkSync(childPath);
    ...
    return {
        ...
        lookup(absolutePath, prevNode) {
            ...
            if (stat.isDirectory()) {
                ...
                try {
                    const target = fs_1.default.readlinkSync(absolutePath);

...
- [iOS] Added `assetName` and `base64` props to `Image` for displaying images in widgets and live activities where network/file I/O is unavailable. ([#44607](https://github.com/expo/expo/pull/44607) by [@sethwebster](https://github.com/sethwebster))
- [iOS] Added `containerBackground`, `invalidatableContent`, `contentMarginsDisabled`, and `unredacted` widget modifiers. ([#44607](https://github.com/expo/expo/pull/44607) by [@sethwebster](https://github.com/sethwebster))

...
import { ScrollView, StyleSheet, Text, View, type NativeSyntheticEvent } from 'react-native';

// Adapted from https://github.com/react-native-community/segmented-control/blob/master/example

const CommunitySegmentedControlScreen = () => {
...
export default CommunitySegmentedControlScreen;
